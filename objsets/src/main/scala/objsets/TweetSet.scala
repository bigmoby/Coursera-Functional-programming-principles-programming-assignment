...
abstract class TweetSet {
  ...
  def mentioning(keywords: List[String]): TweetSet = filter(x => x.mentions(keywords))
...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.mentioning(google)
  lazy val appleTweets: TweetSet = TweetReader.allTweets.mentioning(apple)
